...
{
    public function summary(CreditAlertService $creditAlerts): array
    {
        $today = Carbon::today();
        ...
        $alertSummary = $creditAlerts->summary();
        ...
        return [
            ...
            'overdueCredits' => $alertSummary['overdueCount'],
            'lowStock' => $lowStock,
            ...
            'dueCredits' => $alertSummary['creditAlerts']['upcoming']->take(5),

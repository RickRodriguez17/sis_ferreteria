...
class RolePermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $permissions = array_merge($permissions, ['users.manage', 'returns.view', 'returns.customer.create', 'returns.supplier.create', 'credits.cancel', 'prices.update', 'inventory.adjust', 'inventory.transfer', 'cash.open', 'cash.close', 'cash.movement', 'reports.view', 'audit.view', 'settings.update']);
        ...
        Role::findOrCreate('Gerente')->syncPermissions($all->whereNotIn('name', ['settings.update', 'users.manage', 'users.delete', 'roles.delete']));
        ...
        Role::findOrCreate('Cajero')->syncPermissions(Permission::whereIn('name', ['products.view', 'inventory.view', 'sales.view', 'sales.create', 'credits.view', 'payments.view', 'payments.create', 'cash.view', 'cash.open', 'cash.close', 'cash.movement', 'returns.view', 'returns.customer.create'])->get());
    }
}

...
class RolePermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Role::findOrCreate('Almacenero')->syncPermissions(Permission::whereIn('name', ['products.view', 'products.create', 'products.update', 'inventory.view', 'inventory.adjust', 'inventory.transfer', 'purchases.view', 'purchases.create', 'receptions.view', 'receptions.create'])->get());

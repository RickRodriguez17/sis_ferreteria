...
class RolePermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $permissions = array_merge($permissions, ['users.manage', 'credits.cancel', 'prices.update', 'inventory.adjust', 'inventory.transfer', 'cash.open', 'cash.close', 'cash.movement', 'reports.view', 'audit.view', 'settings.update']);
